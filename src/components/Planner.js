                ...
                <div className="plannercontainer"></div>
                    <form className="row">
                        <div className="form-group col-12 col-lg-9">
                            ...
                            <input type="text" id="destination" name="destination" defaultValue="Paris" className="form-control" ref={props.r}/>
                        ...
                        <div className="col-12 col-lg-3 buttons container">
                            <button type="button" className="btn btn-dark col-4 col-lg-12" onClick={props.btn}>Add trip</button>
